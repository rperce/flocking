...
silent only
cd ~/public_html/flocking
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 index.html
badd +19 sass/theme.scss
badd +0 css/theme.css
badd +0 sass/_flex.scss
args index.html
edit sass/theme.scss
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 341 - ((15 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
341
